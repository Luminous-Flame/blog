...
<div class="card-link">
  <a href="https://github.com/Luminous-Flame/C-Moon" target="_blank">
    <div class="card-content">
      <img class="card-image" src="https://opengraph.githubassets.com/1/github/Luminous-Flame/C-Moon" />
      <div class="card-text">
        <div class="card-main">
          <div class="card-title">C-Moon</div>
          <div class="card-description">Quartz theme with Obsidian-like styles</div>
        </div>
        <div class="card-footer">
          <img class="card-favicon" src="https://github.githubassets.com/favicons/favicon.png" />
          <div class="card-host">github.com</div>
        </div>
      </div>
    </div>
  </a>
